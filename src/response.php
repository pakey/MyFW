...
class Response
{
    ...
    {
        if (Config::get('gzip_encode', false)) {
    ...
    public static function jsonEncode($data, $format = 0)
    {
    ...
    public static function jsonpEncode($data, $format = 0)
    {
     ...
     * @return string
     */
    public static function xmlEncode($data, $root = 'ptcms', $attr = '', $encoding = 'utf-8')
    {
        return Xml::encode($data, $root, $attr, $encoding);
    }
