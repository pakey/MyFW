...
<head>
    ...
    <style type = "text/css">
        ...
        .errorBox {padding: 12px 48px;} .trace-file:hover {
            background: #f0ffff;
        }
        .big {font:50px/1.8 "microsoft yahei"} .info {margin-bottom:20px;} .title {font:bold 20px/1.8 "microsoft yahei"} .text{line-height:2}
		/*]]>*/
	</style>
</head>
<body>
