 ...
 *      $Date: 2013-06-13 03:38:36 +0800 (周四, 2013-06-13) $
 *      $File: Db.class.php $
 *  $Revision: 162 $
 *      $Desc:
 **************************************************************/
...
class Db
{
    ...
    {
        $args = func_get_args();
        return MCPHP::getInstanceOf(__CLASS__, 'factory', $args);
    }
     ...
     * 初始化数据库连接
     * @access protected
     * @param boolean $master 主服务器    // true 写库 false 从库
     * @return void
     */
    ...
    {
        Debug::addMsg('[用时<font color="red">' . $time . '</font>秒] - ' . $this->queryStr, 'sql'); // debug
    }
    ...
    public function buildSelectSql($options = array())
    {
        ...
        if (C('DB_SQL_BUILD_CACHE') and !APP_DEBUG) { // SQL创建缓存
